...
def create_folder_structure(save_location, project_name):
    ...
    folders = [
        ...
        os.path.join(save_location, project_name, "1_media", "1_video", "3_drohne"),
        os.path.join(save_location, project_name, "1_media", "1_video", "4_gopro"),
        os.path.join(save_location, project_name, "1_media", "1_video", "5_stock"),
        os.path.join(save_location, project_name, "1_media", "1_video", "6_screenrecording"),
        os.path.join(save_location, project_name, "1_media", "1_video", "7_vfx"),
        os.path.join(save_location, project_name, "1_media", "2_audio", "1_original_sound"),
        ...
        os.path.join(save_location, project_name, "1_media", "4_subtitles", "1_transcript"),
        os.path.join(save_location, project_name, "1_media", "4_subtitles", "2_srt-captions"),
        ...
        os.path.join(save_location, project_name, "3_export", "2_compositing", "from_compositing", "1_titles"),
        os.path.join(save_location, project_name, "3_export", "2_compositing", "from_compositing", "1_titles", "v01"),
        os.path.join(save_location, project_name, "3_export", "2_compositing", "from_compositing", "2_lower_3rd"),
        os.path.join(save_location, project_name, "3_export", "2_compositing", "from_compositing", "2_lower_3rd", "v01"),
        os.path.join(save_location, project_name, "3_export", "3_color", "for_color"),
        os.path.join(save_location, project_name, "3_export", "3_color", "from_color"),
        os.path.join(save_location, project_name, "3_export", "4_sound_omf", "for_mastering"),
        os.path.join(save_location, project_name, "3_export", "4_sound_omf", "from_mastering"),
